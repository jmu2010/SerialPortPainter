...
namespace WinFormNewApp
{
    class CsvFileDeal
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Jitbit.Utils.CsvFileDeal"/> class.
        /// </summary>
        ...
        /// </param>
        public CsvFileDeal(string columnSeparator = ",", bool includeColumnSeparatorDefinitionPreamble = true, bool includeHeaderRow = true)
        {
